...
<template>
  <div v-if="module" class="max-w-container mx-auto px-6 pt-8 pb-16">
    <!-- Breadcrumb -->
    ...
    <!-- Exercises -->
    <div v-if="module.exercises.length > 0" class="mb-8">
  ...
  <!-- Module not found -->
  <div v-else class="max-w-lg mx-auto mt-24 text-center">
